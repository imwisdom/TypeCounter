...
# load_wb = load_workbook("/home/oem/Desktop/labeled_error8.xlsx", data_only=True)
    ...
    if error_type == 'run-error':
        ...
        if solve :
            ...
            if len(submit_data) > 0 :
                ...
                solve, similarity = check_source_code_using_json(wrong_source_code[0][0].decode(), lang, str(submit_data[0][2]))
...
# load_wb.close()
write_wb.save("/home/oem/Desktop/labeled_error9_2.xlsx")
db.close()
