...
public class TypeChecker {
    ...
    public StringBuilder getJsonString(){
        ...
        HashMap<String, Integer> mapData = getTotalMapData();
        Iterator<String> iter = mapData.keySet().iterator();

        sb.append("{");
        sb.append("\"Map\" : "+countTotalMapData()+", ");
        sb.append("\"List\" : "+countTotalListData()+", ");
        sb.append("\"Array\" : "+countTotalArrayData()+", ");
        sb.append("\"Table\" : "+countTotalTableData()+", ");
        sb.append("\"Set\" : "+countTotalSetData()+", ");
        sb.append("\"Stack\" : "+countTotalStackData()+", ");
        sb.append("\"Queue\" : "+countTotalQueueData()+", ");
        sb.append("\"PriorityQueue\" : "+countTotalPriorityQueueData()+", ");
        sb.append("\"Deque\" : "+countTotalDequeData()+" }");
