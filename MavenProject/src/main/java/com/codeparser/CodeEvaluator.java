...
//        int[] totalArray2 = new int[8];
//        totalArray2[0] = typeChecker.countTotalMapData();
//        totalArray2[1] = typeChecker.countTotalListData();
//        totalArray2[2] = typeChecker.countTotalArrayData();
//        totalArray2[3] = typeChecker.countTotalStackData();
//        totalArray2[4] = typeChecker.countTotalQueueData();
//        totalArray2[5] = typeChecker.countTotalSetData();
//        totalArray2[6] = typeChecker.countTotalTableData();
//        totalArray2[7] = typeChecker.countTotalNodeData();
//
//        int maxIndex2 = 0;
//        for (int i = 1; i < 8; i++) {
//            if (totalArray2[maxIndex2] < totalArray2[i])
//                maxIndex2 = i;
//        }
//        int[] totalArray = new int[8];
//        totalArray[0] = typeChecker.countTotalMapData();
//        totalArray[1] = typeChecker.countTotalListData();
//        totalArray[2] = typeChecker.countTotalArrayData();
//        totalArray[3] = typeChecker.countTotalStackData();
//        totalArray[4] = typeChecker.countTotalQueueData();
//        totalArray[5] = typeChecker.countTotalSetData();
//        totalArray[6] = typeChecker.countTotalTableData();
//        totalArray[7] = typeChecker.countTotalNodeData();
//
//        int maxIndex = 0;
//        for (int i = 1; i < 8; i++) {
//            if (totalArray[maxIndex] < totalArray[i])
//                maxIndex = i;
//        }
//
//        if (totalArray[maxIndex] == 0) return "알고리즘이 잘못됨";
//        switch (maxIndex) {
//            case 0:
//                return "Map 사용 방식이 잘못됨";
//            case 1:
...
//    private boolean isUsedAllMethod(){
//        HashMap<String, Integer> functionHashMap = methodChecker.getFunctionMap();
//
//        Set<String> set = functionHashMap.keySet();
//        Iterator<String> iter = set.iterator();
//
//        while(iter.hasNext()){
//            if(functionHashMap.get(iter.next())<2){
//                return false;
//            }
//        }
//        return true;
